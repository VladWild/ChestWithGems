...
class Play implements Command {
    ...
    private final static String UP = "button_play_up";
    private final static String DOWN = "button_play_down";

    private final GridPoint2 BUTTON_SIZE = new GridPoint2((int) (0.3f * WIDTH), (int) (0.05f * HIGHT));
    private final Rectangle TABLE_SIZE = new Rectangle(0, 0, WIDTH, 0.8f * HIGHT);

    private ChestWithGems game;

    public Play(ChestWithGems game){
        this.game = game;
    }
