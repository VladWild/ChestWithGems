...
public class LeftSpeed implements Command {
    ...
    private final Rectangle TABLE_SIZE  = new Rectangle(0.2f * WIDTH, 0.2f * HIGHT, 0.3f * WIDTH, 0.35f * HIGHT);

    private GamePlaySettings settings;

    public LeftSpeed(GamePlaySettings settings){
